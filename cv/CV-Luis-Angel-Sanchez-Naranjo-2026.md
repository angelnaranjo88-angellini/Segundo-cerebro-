...
- `[tu teléfono]`
- angelnaranjo88@aragon.unam.mx
- Ciudad de México
- `[LinkedIn]` · `[GitHub o portafolio]`
...
- Monitoreo de costo y tasa de error por escenario; documentación técnica de todo el
  portafolio en un repositorio propio versionado.

### Secretaría de la Función Pública — Servicio Social
**Control Interno y Administración de Riesgos** · Diciembre 2023 – Junio 2024

- Atención de consultas telefónicas y por correo en materia de Control Interno y
  Administración de Riesgos.
- Gestión de solicitudes de habilitación al sistema **SICOIN**, incluidas habilitaciones
  extemporáneas, y asignación de usuarios de enlace (SICOIN, ARI, COCODI).
- Registro de Matrices de Administración de Riesgos y apoyo en la revisión de Opiniones
  Metodológicas.
- Manejo de archivo documental físico en el **SICOA** y actualización de directorios
  institucionales.
...
Español (nativo) · Inglés intermedio-avanzado (constancia CLE, UNAM) · Portugués
(comprensión lectora)
